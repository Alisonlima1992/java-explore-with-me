package stc.main.java.ru.practicum.ewm.repository;

import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.data.jpa.repository.Query;
import stc.main.java.ru.practicum.ewm.model.EndpointHit;
import ru.practicum.ewm.dto.ViewStats; // ← ИСПРАВЛЕННЫЙ ИМПОРТ
...
public interface StatsRepository extends JpaRepository<EndpointHit, Long> {
    ...
    @Query("SELECT new ru.practicum.ewm.dto.ViewStats(h.app, h.uri, COUNT(h.ip)) " +
            "FROM EndpointHit h " +
